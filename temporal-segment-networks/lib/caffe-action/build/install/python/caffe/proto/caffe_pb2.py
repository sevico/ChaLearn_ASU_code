...
SegDataParameter = _reflection.GeneratedProtocolMessageType('SegDataParameter', (_message.Message,), dict(
  DESCRIPTOR = _SEGDATAPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.SegDataParameter)
  ))
_sym_db.RegisterMessage(SegDataParameter)
...
BatchReductionParameter = _reflection.GeneratedProtocolMessageType('BatchReductionParameter', (_message.Message,), dict(
  DESCRIPTOR = _BATCHREDUCTIONPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.BatchReductionParameter)
  ))
_sym_db.RegisterMessage(BatchReductionParameter)

MemoryOptimizationParameter = _reflection.GeneratedProtocolMessageType('MemoryOptimizationParameter', (_message.Message,), dict(
  DESCRIPTOR = _MEMORYOPTIMIZATIONPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.MemoryOptimizationParameter)
  ))
_sym_db.RegisterMessage(MemoryOptimizationParameter)
